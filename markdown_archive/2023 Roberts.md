...
## 1 Introduction
A sustained human presence on the lunar and Martian surfaces will require habitats with thick walls and ceilings for protection against radiation exposure and meteor strikes. Due to the high cost of transporting mass from Earth to space, bulk construction materials will be produced from locally available resources – a concept known as *in situ* resource utilisation (ISRU). The stabilisation of loose, unconsolidated regolith into a solid concrete-like material would provide radiation- and micrometeoroid-shielding and allow the deployment of relatively lightweight, inflatable habitats.

Starch (amylum) is an abundant plant-based carbohydrate and is the main source of calories in the human diet. It is also employed industrially as an adhesive/binder. Having limited water on the Moon and Mars, the issue of moisture sensitivity (a key weakness for Earth-based starch biocomposites) is irrelevant. Surplus starch produced from staple foods like rice, potatoes, and maize could avoid the need for additional construction material fabrication equipment.

## 2 Results and Discussion
Potato starch was identified as the most effective source, having an ultimate compressive strength (UCS) of 17.7 MPa in screening tests. 
...
Experimental optimization using Design of Experiments (DoE) focused on additives like MgCl2 and urea. Martian chloride salt deposits (MgCl2) and urea (from urine) were tested as binders. 

### Table 2: Effect of additive incorporation on UCS of ERBs.
...
StarCrete provides a simple, high-tech readiness solution for extraterrestrial construction. Key advantages include:
1. **Risk reduction:** Edible binder can be consumed in emergencies.
2. **Practicality:** Low energy process compared to sintering or melting.
3. **System integration:** Links food production and construction.
4. **Resourcefulness:** Most water used can be recovered via dehydration.
5. **Resource locality:** Starch can be produced on-site.
6. **Architectural flexibility:** High strength allows for thinner, more complex structures.